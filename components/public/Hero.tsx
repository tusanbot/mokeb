...
export default function Hero() {
    return (
        <section className="relative overflow-hidden bg-[var(--primary-dark)] text-white">
            ...
            <div
                className="pointer-events-none absolute -bottom-40 -left-32 h-[28rem] w-[28rem] rounded-full border border-[var(--gold)]/15"
                aria-hidden="true"
            />

            <div
                className="pointer-events-none absolute right-1/2 top-1/2 h-80 w-80 -translate-y-1/2 translate-x-1/2 rounded-full bg-white/[0.025]"
                aria-hidden="true"
            />
                ...
                <div className="grid min-h-[560px] items-center gap-14 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:py-24">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                            <a
                                href="#goals"
                                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--gold)] px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 hover:bg-[#b88b30]"
                            >
                                <span>
                                    مشاهده اهداف موکب
                                </span>
                            ...
                            <a
                                href="#donations"
                                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/[0.06] px-6 py-3.5 text-sm font-bold text-white transition hover:bg-white/[0.1]"
                            >
                                <HeartHandshake
                                    size={18}
                                    strokeWidth={1.8}
                        ...
                        <div className="mt-8 flex items-center gap-3 text-sm text-white/55">
                            ...
                            <span>
                                گزارش شفاف اهداف، برنامه‌ها و نذورات موکب
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
                        <div className="relative aspect-square overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-2xl">
                            {/* Decorative Frame */}
                            <div
                                className="absolute inset-6 rounded-[1.5rem] border border-[var(--gold)]/20"
                                aria-hidden="true"
                            />
                            ...
                            <div
                                className="absolute inset-20 rounded-full border border-[var(--gold)]/10"
                                aria-hidden="true"
                            />
                            ...
                            {/* Corner Details */}
                            <div
                                className="absolute right-5 top-5 h-3 w-3 rounded-full bg-[var(--gold)]"
                                aria-hidden="true"
                            />

                            <div
                                className="absolute bottom-5 left-5 h-3 w-3 rounded-full bg-[var(--gold)]"
                                aria-hidden="true"
                            />

                            <div
                                className="absolute bottom-5 right-5 h-2 w-2 rounded-full bg-white/30"
                                aria-hidden="true"
                            />

                            <div
                                className="absolute left-5 top-5 h-2 w-2 rounded-full bg-white/30"
                                aria-hidden="true"
                            />
                        </div>
                    </div>
